...
HD_PWD='D:/Respository/fpga_taxi/fpga_taxi/taxi/taxi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log taxi_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source taxi_top.tcl
