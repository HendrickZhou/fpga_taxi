...
HD_PWD='D:/Respository/fpga_taxi/fpga_taxi/taxi/taxi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log taxi_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source taxi_top.tcl -notrace
